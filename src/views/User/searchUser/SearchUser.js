                ...
                <Table className="border-2 rounded-xl" aria-label="simple table">
                  <TableBody>
                    <TableRow hover>
                      ...
                      <TableCell className="text-lg">{userData.user_name || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="">Email :</TableCell>
                      <TableCell className="text-lg">{userData.email || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="text-lg">gender :</TableCell>
                      <TableCell className="text-lg">{userData.gender || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="text-lg">mobile :</TableCell>
                      <TableCell className="text-lg">{userData.mobile || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="text-lg">home location addressline:</TableCell>
                      <TableCell className="text-lg">{userData.home_location_addressline1 || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="text-lg">home location city :</TableCell>
                      <TableCell className="text-lg">{userData.home_location_city || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="text-lg">home location postal code</TableCell>
                      <TableCell className="text-lg">{userData.home_location_postal_code || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="text-lg">home location state :</TableCell>
                      <TableCell className="text-lg">{userData.home_location_state || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="text-lg">office location address</TableCell>
                      <TableCell className="text-lg">{userData.office_location_addressline1 || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="text-lg">office location city</TableCell>
                      <TableCell className="text-lg">{userData.office_location_city || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="text-lg">office location postal code</TableCell>
                      <TableCell className="text-lg">{userData.office_location_postal_code || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="text-lg">office location state</TableCell>
                      <TableCell className="text-lg">{userData.office_location_state || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="text-lg">OTP</TableCell>
                      <TableCell className="text-lg">{userData.user_otp || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="text-lg">Otp created At</TableCell>
                      <TableCell className="text-lg">{userData.otp_createdAt || 'NA'}</TableCell>
                    </TableRow>
                    <TableRow hover>
                      <TableCell className="text-lg">Otp expired At</TableCell>
                      <TableCell className="text-lg">{userData.otp_expiredAt || 'NA'}</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </TableContainer>
